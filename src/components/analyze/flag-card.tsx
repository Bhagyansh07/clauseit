  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-3">
        ...
        <span
          className={`shrink-0 rounded-full px-2.5 py-0.5 text-xs font-semibold ${meta.badge}`}
        >
          {meta.label}
        </span>
      </div>
      ...
      <p className="mt-3 flex items-start gap-2 text-sm font-medium text-violet">
        <MoveRight className="mt-0.5 h-4 w-4 shrink-0 text-fuchsia" aria-hidden="true" />
        {action[lang]}
      </p>
    </div>
  );
